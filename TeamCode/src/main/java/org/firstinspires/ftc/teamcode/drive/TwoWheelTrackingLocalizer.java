...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = -4.251969; // X is the up and down direction
    public static double PARALLEL_Y = -1.062992; // Y is the strafe direction

    public static double PERPENDICULAR_X = 3.74;
    public static double PERPENDICULAR_Y = -2.55;
