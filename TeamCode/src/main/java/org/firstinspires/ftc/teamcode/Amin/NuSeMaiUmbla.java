...
public class NuSeMaiUmbla {
    ...
    public static double X_MULTIPLIER_CT = 1;
    public static double Y_MULTIPLIER_CT = 1;

    public static double PARALLEL_X_CT = -4.251969;
    public static double PARALLEL_Y_CT = -1.062992;
